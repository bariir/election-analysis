...
with open(file_to_load) as election_data:
    ...
    for row in file_reader:
        ...
        # If the candidate does not match any existing candidate.... get unique candidate
        if candidate_name not in candidate_options:
            # Add it to the list candidates.
...
for candidate_name in candidate_votes:
    ...
    # 4. Print out each candidate's name, vote count, and percentage of 
